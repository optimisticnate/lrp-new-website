  ...
  const navigation = [
    { name: 'Home', href: '/' },
    {
      ...
      dropdownItems: [
        ...
        { name: 'Golf Outing Transportation', href: '/golf-outing-transportation' },
        { name: 'Charter Bus Service', href: '/charter-bus-service' },
        { name: 'Group Event Transportation', href: '/group-event-transportation' },
        { name: 'Lake Ozarks Tours', href: '/lake-ozarks-tours' },
        { name: "New Year's Eve Transport", href: '/new-years-eve-transportation' },
      ]
    },
